...
def get_word_score(word, n):
    ...
    znach=7 * len(word2) - 3 * (n - len(word2))
    if znach<1:
        znach=1
    return count*znach
        ...
        for i in word_dict.keys():
            if i in hand.keys():
                if word_dict[i] <= hand[i]:
                    list1_forcheck.append("True")
                else:
                    list1_forcheck.append("False")
            else:
                list1_forcheck.append("False")
    elif "*" in word:
        word_in = False
        for k in VOWELS:
            word2 = word.replace("*", k)
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while help==1:
       ...
       word=input()
       if word=="!!":
           print("Total score: ",count,"points")
           help=2
       elif is_valid_word(word, hand, word_list)==True:
           score=get_word_score(word,calculate_handlen(hand))
           count=count+score
           print(word,"earned",score,"points. Total:",count,"points")
           if (update_hand(hand, word))=={}:
               print("Ran out of letters. Total score: ", count, "points")
               help=2
           else:
...
def substitute_hand(hand, letter):
    ...
    letter=letter.lower()
    count=hand[letter]
    all_letter='bcdfghjklmnpqrstvwxyz'+'aeiou'
    for i in hand.keys():
        all_letter=all_letter.replace(i,"")
    hand.pop(letter)
    new_letter = random.choice(all_letter)
    ...
    * Returns the total score for the series of hands
    ...
    while check==1:
     try:
        ...
        print("You enter wrong number of hands value")
     count2=0
     count = 0
    for i in range(number_of_hands):
      ...
      while check2==1:
       ...
       if ans=="yes":
          ...
          print('You must answer "yes" or "no" only ')
       else:
           break
      count2=count2+count
      help=1
      ...
      while help==1:
       ...
       word=input()
       if word=="!!":
           print("Total score for this hand: ",count,"points")
           ...
           print("")
           if (update_hand(hand, word))=={}:
               print("Ran out of letters. Total score for this hand: ", count, "points")
               print("________________________________")
               help=2
           else:
               hand = update_hand(hand, word)
           ...
           print("This is not a valid word. Please choose another word.")
    print("Total score over all hands:",count2+count)
